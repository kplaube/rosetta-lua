...
describe('Exponential Operator', function()
    ...
    it('should return N multiplied X times by an even X', function()
        local n = 3
        local x = 2
        local response = exp_op.custom_pow(n, x)
